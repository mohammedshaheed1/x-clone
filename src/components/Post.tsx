  ...
  return (
    <div className="p-4 border-y-[1px] border-borderGray">
      ...
      <div className={`flex gap-4 ${type === "status" && "flex-col"}`}>
        ...
        >
          <Imag path={originalPost.user.img || "general/avatar.png"} alt="" w={100} h={100} tr={true} />
        </div>
        ...
        <div className="flex-1 flex flex-col gap-2">
          ...
          <PostInteractions count={originalPost._count} isLiked={!!originalPost.likes.length} isReposted={!!originalPost.rePosts.length} isSaved={!!originalPost.saves.length} />
        </div>
      </div>
    </div>
  );
